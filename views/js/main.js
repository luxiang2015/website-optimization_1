...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var leng = pizzaContainer.length;
...
// The calculation is put outside the for loop to safe time
  ...
  var phase0 = Math.sin(cal);
  var phase1 = Math.sin(cal + 1);
  var phase2 = Math.sin(cal + 2);
  var phase3 = Math.sin(cal + 3);
  var phase4 = Math.sin(cal + 4);
  var phase = [phase0, phase1, phase2, phase3, phase4];
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var numberOfPizza = window.innerHeight/100 * 8;
